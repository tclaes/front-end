...
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
__webpack_require__(7).default("a07579c2", content, true)
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, "body{background:#333;display:grid;align-content:center;justify-content:center;place-content:center;height:100vh;margin:0;padding:0;width:100vw}.red{color:red}", ""]);
// Exports
module.exports = exports;
...
const _67f23bfc = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 1).then(__webpack_require__.bind(null, 23))); // TODO: remove in Nuxt 3
